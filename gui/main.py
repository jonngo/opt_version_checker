...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.merge_result_label = QtWidgets.QLabel(self.centralwidget)
        self.merge_result_label.setObjectName("merge_result_label")
        self.verticalLayout_8.addWidget(self.merge_result_label)
        self.merge_result_table = QtWidgets.QTableView(self.centralwidget)
        self.merge_result_table.setObjectName("merge_result_table")
        self.verticalLayout_8.addWidget(self.merge_result_table)
        ...
        self.merge_result_hide_pushbutton = QtWidgets.QPushButton(self.merge_result_buttom_button_frame)
        self.merge_result_hide_pushbutton.setObjectName("merge_result_hide_pushbutton")
        self.horizontalLayout_7.addWidget(self.merge_result_hide_pushbutton)
        self.merge_result_export_pushbutton = QtWidgets.QPushButton(self.merge_result_buttom_button_frame)
        self.merge_result_export_pushbutton.setObjectName("merge_result_export_pushbutton")
        self.horizontalLayout_7.addWidget(self.merge_result_export_pushbutton)
        ...
        self.merge_show_menu_item = QtWidgets.QAction(MainWindow)
        self.merge_show_menu_item.setObjectName("merge_show_menu_item")
        self.merge_hide_menu_item = QtWidgets.QAction(MainWindow)
        self.merge_hide_menu_item.setObjectName("merge_hide_menu_item")
        ...
        self.show_only_merge_result_menu_item = QtWidgets.QAction(MainWindow)
        self.show_only_merge_result_menu_item.setObjectName("show_only_merge_result_menu_item")
        ...
        self.menuResult.addAction(self.merge_show_menu_item)
        self.menuResult.addAction(self.merge_hide_menu_item)
        ...
        self.menuShow_Only.addAction(self.show_only_merge_result_menu_item)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.merge_result_label.setText(_translate("MainWindow", "Merged Result"))
        self.merge_result_hide_pushbutton.setText(_translate("MainWindow", "Hide"))
        self.merge_result_export_pushbutton.setText(_translate("MainWindow", "Export"))
        self.job_bundle_pkg_ver_label.setText(_translate("MainWindow", "Job Bundle Package Version"))
        ...
        self.menuResult.setTitle(_translate("MainWindow", "Merged Result"))
        ...
        self.jbz_pkg_menuItem.setText(_translate("MainWindow", "Job Bundle"))
        ...
        self.merge_show_menu_item.setText(_translate("MainWindow", "Show"))
        self.merge_hide_menu_item.setText(_translate("MainWindow", "Hide"))
        ...
        self.show_only_merge_result_menu_item.setText(_translate("MainWindow", "Merged Result"))
