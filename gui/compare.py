...
class Ui_compare_widget(object):
    def setupUi(self, compare_widget):
        ...
        self.compare_push_button = QtWidgets.QPushButton(self.frame)
        self.compare_push_button.setObjectName("compare_push_button")
        self.horizontalLayout.addWidget(self.compare_push_button)
    ...
    def retranslateUi(self, compare_widget):
        ...
        self.compare_push_button.setText(_translate("compare_widget", "Compare"))
