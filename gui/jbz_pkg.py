...
class Ui_pkg_widget(object):
    def setupUi(self, pkg_widget):
        ...
        self.jbz_path_line_edit = QtWidgets.QLineEdit(self.frame)
        self.jbz_path_line_edit.setEnabled(True)
        self.jbz_path_line_edit.setObjectName("jbz_path_line_edit")
        self.gridLayout.addWidget(self.jbz_path_line_edit, 0, 1, 1, 1)
        ...
        self.jbz_path_push_button = QtWidgets.QPushButton(self.frame)
        self.jbz_path_push_button.setObjectName("jbz_path_push_button")
        self.gridLayout.addWidget(self.jbz_path_push_button, 0, 2, 1, 1)
        ...
        self.extract_push_button = QtWidgets.QPushButton(pkg_widget)
        self.extract_push_button.setObjectName("extract_push_button")
        self.horizontalLayout_3.addWidget(self.extract_push_button)
        self.close_push_button = QtWidgets.QPushButton(pkg_widget)
        self.close_push_button.setObjectName("close_push_button")
        self.horizontalLayout_3.addWidget(self.close_push_button)
        self.verticalLayout.addLayout(self.horizontalLayout_3)

        self.retranslateUi(pkg_widget)
        self.close_push_button.clicked.connect(pkg_widget.hide)
    ...
    def retranslateUi(self, pkg_widget):
        ...
        self.jbz_path_push_button.setText(_translate("pkg_widget", "Browse"))
        ...
        self.extract_push_button.setText(_translate("pkg_widget", "Extract"))
        self.close_push_button.setText(_translate("pkg_widget", "Close"))
